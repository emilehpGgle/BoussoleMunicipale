...
('respect_citoyens', 'Respect et citoyens', 'RC', 'Claude Villeneuve', '/logos/respect-citoyens-new.jpg', '#2e7d32', 'https://respectcitoyens.ca/', 'Participation citoyenne et environnement', 'Formation politique mettant l''accent sur la participation citoyenne, la transparence démocratique et la protection environnementale. Prône une approche collaborative de la gouvernance municipale.', ARRAY['Participation citoyenne', 'Environnement et espaces verts', 'Transport durable'], NOW(), NOW()),
