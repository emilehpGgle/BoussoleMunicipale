    ...
    <div className="mobile-constrained">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="flex flex-col space-y-6 animate-slideInUp" style={{ animationDelay: "0.1s" }}>
              <span className="text-sm font-semibold text-muted-foreground/80 flex items-center">
                <Compass className="w-5 h-5 mr-2" /> Votre <ColoredText variant="gradient" intensity="subtle">boussole citoyenne</ColoredText>
              </span>
              ...
              <p className="text-lg text-muted-foreground max-w-lg">
                Notre <HighlightText>boussole interactive</HighlightText> vous aide à comprendre les enjeux locaux et à trouver les candidats qui
                correspondent à vos <ColoredText variant="primary" intensity="subtle">priorités</ColoredText>. Simple, neutre et personnalisé.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 mt-4">
                <div className="flex flex-col gap-2">
                  ...
                  <span className="text-xs text-muted-foreground text-center sm:text-left">⏱️ <ColoredText variant="secondary" intensity="subtle">5 minutes</ColoredText> • <ColoredText variant="accent" intensity="subtle">20 questions</ColoredText></span>
                </div>
                <Button
                  size="lg"
                  variant="outline"
      ...
      <section id="comment-ca-marche" className="section-contained w-full py-16 md:py-24 bg-background">
        <div className="container px-4 md:px-6 max-w-7xl mx-auto">
          <h2 className="text-center mb-12 text-foreground animate-slideInUp" style={{ animationDelay: "0.2s" }}>
            Comment ça <ColoredText variant="gradient" intensity="medium">fonctionne</ColoredText> ?
          </h2>
      ...
      >
        <div className="container px-4 md:px-6 max-w-6xl mx-auto text-center">
          ...
          >
            <h2 className="mb-6 text-foreground">Pourquoi les <ColoredText variant="gradient" intensity="medium">élections municipales</ColoredText> sont-elles importantes ?</h2>
            <p className="text-lg text-muted-foreground mb-10 max-w-4xl mx-auto leading-relaxed">
              Votre ville influence directement votre <HighlightText>quotidien</HighlightText> : transports, parcs, taxes, services de proximité. 
              Pourtant, seulement <ColoredText variant="primary" intensity="bold">40% des citoyens</ColoredText> votent aux municipales. 
              Votre <ColoredText variant="accent" intensity="medium">voix compte</ColoredText> encore plus !
            </p>
          </div>
            ...
            {[
              ...
              >
                <div className="text-3xl font-bold mb-2">
                  <ColoredText variant="gradient" intensity="bold">{item.stat}</ColoredText>
                </div>
      ...
      <section className="section-contained w-full py-16 md:py-24 bg-muted/30 overflow-hidden">
        <div className="container px-4 md:px-6 max-w-7xl mx-auto overflow-hidden">
          <div className="grid gap-8 md:gap-12 items-center md:grid-cols-2 w-full">
            ...
            >
              <h2 className="mb-6 text-foreground">Votre <ColoredText variant="gradient" intensity="medium">vie privée</ColoredText>, notre priorité.</h2>
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Utilisez la Boussole Municipale en toute <HighlightText>confiance</HighlightText>. Vos réponses sont <ColoredText variant="accent" intensity="subtle">anonymes</ColoredText> et ne sont utilisées que
      ...
      {/* Section Call-to-Action avec glow subtil */}
      <GlowSection 
        glowProps={{ 
          mode: 'pulse', 
          intensity: 'soft',
        ...
        className="section-contained w-full py-16 md:py-20 bg-gradient-to-r from-primary to-teal-special"
      >
        <div className="container px-4 md:px-6 max-w-6xl mx-auto text-center">
          <div className="animate-slideInUp" style={{ animationDelay: "0.2s" }}>
            <h2 className="mb-6 text-primary-foreground">Prêt à découvrir vos <ColoredText variant="gradient" intensity="bold" className="text-white/90 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">affinités politiques</ColoredText> ?</h2>
            <p className="text-lg text-primary-foreground/90 mb-10 max-w-3xl mx-auto leading-relaxed">
              Participez à notre <span className="font-semibold text-white">questionnaire interactif</span> et obtenez une vue claire de votre positionnement politique municipal.
            </p>
            <Button
              size="lg"
              onClick={openModal}
