...
export const partiesData: Party[] = [
  ...
  },
  {
    ...
    leaderPhotoUrl: "/Leaders/Stephane_Lachance.jpg",
    color: "#D32F2F",
  ...
  },
  {
    ...
    logoUrl: "/logos/parti-du-monde.png",
    leaderPhotoUrl: "/Leaders/Anne_Guerette.jpg",
    color: "#1E3A8A",
    websiteUrl: "https://partidumonde.com/",
    orientation: "Centre participatif, gouvernance collaborative",
    strengths: ["Consultation citoyenne renforcée", "Transparence financière", "Vision transport innovante", "Approche collaborative", "États généraux habitation"],
    reserves: ["Nouveau parti sans expérience", "Positions encore en développement", "Équipe en formation"],
    mainIdeasSummary: createSummary(
      "Centre participatif, gouvernance collaborative",
      ["Consultation citoyenne renforcée", "Transparence financière", "Vision transport innovante", "Approche collaborative", "États généraux habitation"],
      ["Nouveau parti sans expérience", "Positions encore en développement", "Équipe en formation"],
    ),
    priorities: ["Gouvernance et démocratie", "Transport et mobilité", "Logement abordable"],
    positions: [
      {
        questionId: questionIdMap[0],
        position: "PA",
      ...
      },
      {
        ...
        note: "Développement d'un réseau de transport intégré favorisant la fluidité urbaine pour tous les citoyens",
      },
      {
        questionId: questionIdMap[4],
        position: "FA",
        source: "Plan de campagne 2025 - Parti du Monde (page 9)",
        note: "États généraux sur l'habitation - Grande consultation publique pour élaborer des solutions réalistes",
      },
      {
        questionId: questionIdMap[5],
        position: "N",
      ...
      },
      {
        ...
        position: "PA",
        source: "Plan de campagne 2025 - Parti du Monde (page 9)",
        note: "Révision du plan d'urbanisme avec préservation des patrimoines et protection des paysages urbaines",
      },
      {
        questionId: questionIdMap[7],
        position: "N",
        source: "Plan de campagne 2025 - Parti du Monde",
        note: "Position équilibrée sur les règlements environnementaux",
      },
      {
        questionId: questionIdMap[8],
        position: "FA",
        source: "Plan de campagne 2025 - Parti du Monde (page 9)",
        note: "Fonds d'habitation sociale, communautaire et coopérative pour rendre l'accès à la propriété possible",
      },
      {
        questionId: questionIdMap[9],
        position: "PA",
        source: "Plan de campagne 2025 - Parti du Monde (page 4)",
        note: "Vision structurante de développement durable et de vitalité économique, sociale et culturelle",
      },
      {
        questionId: questionIdMap[10],
        position: "PA",
        source: "Plan de campagne 2025 - Parti du Monde (page 10)",
        note: "Économie respectueuse de l'environnement et promotion des initiatives d'économie circulaire",
      },
      {
        questionId: questionIdMap[11],
        position: "N",
        source: "Plan de campagne 2025 - Parti du Monde",
        note: "Approche équilibrée sur les règlements de construction",
      },
      {
        questionId: questionIdMap[12],
        position: "PA",
        source: "Plan de campagne 2025 - Parti du Monde (page 5)",
        note: "Construction d'un quatrième lien - Infrastructure stratégique pour désengorger les axes existants",
      },
      {
        questionId: questionIdMap[13],
        position: "PA",
        source: "Plan de campagne 2025 - Parti du Monde (page 11)",
        note: "Programmes de soutien pour renforcer le tissu commercial local et maintenir la vitalité des artères",
      },
      {
        questionId: questionIdMap[14],
        position: "FA",
        source: "Plan de campagne 2025 - Parti du Monde (page 10)",
        note: "Réactiver le rôle du maire comme leader et catalyseur du monde économique pour toute la région",
      },
      {
        questionId: questionIdMap[15],
        position: "N",
        source: "Plan de campagne 2025 - Parti du Monde (page 8)",
        note: "Transparence totale dans la gestion des finances publiques avec vérifications indépendantes",
      },
      {
        questionId: questionIdMap[16],
        position: "FA",
        source: "Plan de campagne 2025 - Parti du Monde (page 8)",
        note: "Consultation citoyenne renforcée - Mécanismes permanents d'écoute et de dialogue avec tous les secteurs",
      },
      {
        questionId: questionIdMap[17],
        position: "N",
        source: "Plan de campagne 2025 - Parti du Monde",
        note: "Position équilibrée sur les effectifs de sécurité publique",
      },
      {
        questionId: questionIdMap[18],
        position: "PA",
        source: "Plan de campagne 2025 - Parti du Monde (page 11)",
        note: "Investissement dans la création d'événements qui mettent en valeur notre territoire et notre patrimoine",
      },
      {
        questionId: questionIdMap[19],
        position: "FA",
        source: "Plan de campagne 2025 - Parti du Monde (page 9)",
        note: "Préservation des patrimoines naturels et bâtis, protection des paysages et perspectives urbaines",
      },
      {
        questionId: questionIdMap[20],
        position: "FA",
        source: "Plan de campagne 2025 - Parti du Monde (page 4)",
        note: "Priorités : gouvernance participative, transport innovant, logement digne, développement durable",
      },
    ],
  },
]
