  ...
  },
  {
    ...
    positions: [
      ...
      },
      {
        questionId: questionIdMap[11],
        position: "N",
        source: "Déclarations partielles au sujet de l'immatriculation; position finale à confirmer",
        note: "Formulation neutralisée compte tenu d'engagements économiques peu détaillés",
      },
      {
      ...
      },
      {
        ...
        position: "N",
        source: "Peu de prises de position détaillées en 2025 sur incitatifs fiscaux aux entreprises",
        note: "Neutralité par manque de précisions publiques",
      },
      {
        questionId: questionIdMap[15],
        position: "N",
